...
class StaffAccessGroup extends BaseObjectAccessGroup {
  public async hasMember(_userId: string): Promise<boolean> {
    return false;
  }
}
...
function createObjectAccessGroup(
  ...
  switch (group.type) {
    case ObjectAccessGroupType.STAFF:
      return new StaffAccessGroup(group.type, group.id);
    default:
